            ...
            <div className="blog">
              ...
              <div key={post_idx} className="post">
                <div className="post-inner">
                  {_.get(post, 'frontmatter.image_thumbnail') && 
                  <Link className="post-thumbnail" to={safePrefix(_.get(post, 'url'))}>
                    <img src={safePrefix(_.get(post, 'frontmatter.image_thumbnail'))} alt={_.get(post, 'frontmatter.title')} />
                  </Link>
                  }
                  <div className="post-content">
                    <h2>
                      <Link to={safePrefix(_.get(post, 'url'))}>{_.get(post, 'frontmatter.title')}</Link>
                    </h2>
